<div class="tih-event-alert my-32 bg-accent p-12 tih-appear-on-scroll">
    ...
    <a href="https://www.umbo.wtf/event/chaot-innen-party-soli-rave" class="block p-4 bg-background text-accent hover:text-background hover:bg-accent border-solid border-2 border-background transition-all text-2xl text-center font-bold mt-8" target="_blank">Mehr Infos</a>
</div>
